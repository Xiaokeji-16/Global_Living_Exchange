      ...
      <div className="flex-1 flex items-center justify-center px-6 py-10 lg:px-12 bg-[#f7f7f8]">
        <div className="w-full max-w-[520px]">
                ...
                <form onSubmit={handleVerifyEmail} className="space-y-5">
                  ...
                  <div className="flex gap-3">
                    <button
                      ...
                      className="flex-1 h-[52px] rounded-2xl border border-[#d0d5dd] text-[#344054] font-medium hover:bg-[#fafafa] disabled:opacity-60"
                    >
                      Resend code
                    </button>
                    <button
                      ...
                      className="flex-1 h-[52px] rounded-2xl border border-[#d0d5dd] text-[#344054] font-medium hover:bg-[#fafafa]"
                    >
                      Start over
                    </button>
                  </div>
          ...
          <div className="mt-8 text-center text-[16px] text-[#667085]">
            ...
            <a href="/sign-in" className="font-semibold text-[#2563eb] hover:text-[#1d4ed8]">
              Sign in
            </a>
          </div>
        </div>
